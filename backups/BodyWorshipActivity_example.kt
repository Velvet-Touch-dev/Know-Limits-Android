...
import com.velvettouch.nosafeword.DeveloperSettingsActivity
...
class BodyWorshipActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun loadVoiceSettings() {
        val prefs = getSharedPreferences(DeveloperSettingsActivity.PREF_VOICE_SETTINGS, Context.MODE_PRIVATE)
        voicePitch = prefs.getFloat(DeveloperSettingsActivity.PREF_VOICE_PITCH, DeveloperSettingsActivity.DEFAULT_PITCH)
        voiceSpeed = prefs.getFloat(DeveloperSettingsActivity.PREF_VOICE_SPEED, DeveloperSettingsActivity.DEFAULT_SPEED)
    }
