...
class DeveloperSettingsActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun loadSettings() {
        val prefs = getSharedPreferences(PREF_VOICE_SETTINGS, Context.MODE_PRIVATE)
        currentPitch = prefs.getFloat(PREF_VOICE_PITCH, DEFAULT_PITCH)
        currentSpeed = prefs.getFloat(PREF_VOICE_SPEED, DEFAULT_SPEED)
    ...
    private fun saveSettings() {
        val prefs = getSharedPreferences(PREF_VOICE_SETTINGS, Context.MODE_PRIVATE)
        prefs.edit()
            .putFloat(PREF_VOICE_PITCH, currentPitch)
            .putFloat(PREF_VOICE_SPEED, currentSpeed)
            .apply()
    }
}
